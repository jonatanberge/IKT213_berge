...
# For matching the fingerprint images:
"""
dataset_path = "images"      # if you put dataset images inside the images/ folder
results_folder = "results"   # will create a results/ folder next to orb.py

process_dataset(dataset_path, results_folder)
"""

#For matching the UiA images
#"""
match_count, match_img = match_fingerprints("UiA front1.png", "UiA front3.jpg")
print("Good matches:", match_count)
if match_img is not None:
    cv2.imwrite("sift_matched_result.jpg", match_img)
#"""